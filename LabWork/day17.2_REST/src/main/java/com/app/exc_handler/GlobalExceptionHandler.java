...
public class GlobalExceptionHandler {
	...
	public ApiResponseStudent     handleResourceNotFoundException(
			ResourceNotFoundException e) {
		System.out.println("in res not found " + e);
		return new ApiResponseStudent(e.getMessage());
	}
	...
	public ApiResponseStudent handleAnyException(RuntimeException e) {
