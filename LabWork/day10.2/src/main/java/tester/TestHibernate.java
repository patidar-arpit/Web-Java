...
//
			...
			Employee emp =new Employee(sc.next(),sc.next(),sc.next(),sc.next(),LocalDate.parse(sc.next()),EmployeeType.valueOf(sc.next()),sc.nextDouble());
			System.out.println("Enter the department id");
			System.out.println(edao.addEmpDetails(emp,sc.nextLong()));
