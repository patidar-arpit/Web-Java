...
//TO DO : validate user role : voter 
 ...
 public boolean updateStatusById(int id) throws SQLException {
	    ...
	    pst1 = connection.prepareStatement("update users set status=1  where id = ?");
 ...
 public boolean validateVoterByDate(LocalDate date) {
	...
	public boolean validateVoterByEmail(String email) throws SQLException {
		// TODO Auto-generated method stub
		pst1 = connection.prepareStatement("select * from users where email =?");
